...
from api.views.user_view import UserList, UserDetail, AuthenticatedUserInformationView, UserRolesDetailsView, UserRolesListView, email_exists, username_exists
...
from api.views.cart_view import CartList, CartDetail, get_cart_by_user
...
urlpatterns = [
    ...
    path('user-roles/<int:pk>/', UserRolesDetailsView.as_view()),
    ...
    path('user/', AuthenticatedUserInformationView.as_view()),
    ...
    path('cart/from-user/<int:user_id>/', get_cart_by_user),
