...
def generate_data() -> Tuple[str, str]:
    ...
    try:
        ...
        for i in range(number_of_records):
            ...
            database_cursor.execute("INSERT INTO api_order (user, order_placed_date, received_date, shipping_address, billing_address, coupon, delivered_status, received, refund_requested, refund_granted) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
