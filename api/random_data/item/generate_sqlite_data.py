...
def generate_data() -> Tuple[str, str]:
    ...
    try:
        ...
        for _ in range(number_of_records):
            ...
            database_cursor.execute("INSERT INTO api_itemcategory (name, subcategory) VALUES (?, ?)", (name, subcategory))
        ...
        for _ in range(number_of_records):
            ...
            database_cursor.execute("INSERT INTO api_item (title, category, price, discount_price, available_number, total_number, description, picture) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
