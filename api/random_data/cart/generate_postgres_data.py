...
def generate_data() -> Tuple[str, str]:
    ...
    try:
        ...
        for _ in range(number_of_records):
            ...
            database_cursor.execute("INSERT INTO api_cart (user_id, date_created) VALUES (%s, %s, %s, %s)",
        ...
        for _ in range(number_of_records):
            ...
            database_cursor.execute("INSERT INTO api_cartitem (item_id, cart_id, quantity) VALUES (%s, %s, %s)", (item_id, cart_id, quantity))
